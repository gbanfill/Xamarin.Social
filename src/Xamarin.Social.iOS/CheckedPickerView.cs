...
namespace Xamarin.Social
{
    class CheckedPickerView : UIPickerView
    {
        ...
        public CheckedPickerView(CGRect frame)
            : base(frame)
        {
        ...
        class PickerDelegate : UIPickerViewDelegate
        {
            public override UIView GetView(UIPickerView pickerView, nint row, nint component, UIView view)
            {
                ...
                if (label == null)
                {
                    label = new PickerLabel(new CGRect(16, 0, pickerView.Bounds.Width - 32, 44));
                }

                var cpv = (CheckedPickerView)pickerView;

                var item = cpv.Items[(int)row];
                label.Text = item;
            ...
            public override void Selected(UIPickerView pickerView, nint row, nint component)
            {
                ...
                cpv.SelectedItem = cpv.Items[(int)row];
        ...
        class PickerLabel : UIView
        {
            ...
            public PickerLabel(CGRect frame)
                : base(frame)
            {
                Opaque = false;
                BackgroundColor = UIColor.Clear;
				
                checkLabel = new UILabel(new CGRect(8, 0, 28, 44))
                {
                    Font = LabelFont,
                    BackgroundColor = UIColor.Clear,
                };
                ...
                label = new UILabel(new CGRect(36, 0, frame.Width - 44, 44))
                {
                    Font = LabelFont,
                    BackgroundColor = UIColor.Clear,
                };
